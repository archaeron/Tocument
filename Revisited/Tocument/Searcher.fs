...
let pathToSQLiteDB = @"C:\Users\Nicolas\Documents\GitHub\Tocument\Revisited\BackboneJS.docset\Contents\Resources\docSet.dsidx"
...
type SearchIndex (customerId:string,companyName:string,contactName:string)=
...
let customers = db.GetTable<SearchIndex>()
